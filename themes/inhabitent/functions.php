...
function inhabitent_scripts() {
	...
	wp_enqueue_script( 'font-awesome', 'https://use.fontawesome.com/4ce53ecc7f.js', array(), '4.7.0');
	...
	wp_enqueue_script( 'navigation-search', get_template_directory_uri() . '/js/navigation-search.js' , array('jquery'), false, true );
